...
public class NMapPOIflagType {
    ...
    // Spot, Pin icons
    public static final int FOOD = SINGLE_POI_BASE + 1;
    public static final int SIGHT = FOOD + 1;
    public static final int ACCOMMODATION = SIGHT + 1;
    public static final int SHOPPING = ACCOMMODATION + 1;
    public static final int LIVING = SHOPPING + 1;
    public static final int DEFAULT = LIVING + 1;
    public static final int FOCUS = DEFAULT + 1;
