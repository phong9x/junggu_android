 ...
 */
public class FieldViewSmall extends LinearLayout {

    private Context context;
    private static final String TAG = FieldViewSmall.class.getName();
    ...
    public FieldViewSmall(Context context) {
        super(context);
        init(context);
    }

    public FieldViewSmall(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public FieldViewSmall(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context);
    }

//    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
//    public FieldViewSmall(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//            int filedIdSelected = fieldListId.get(idFilter);
        ...
        if (isFilterAll) {
            if (fieldListId.size() == 1) {
                ...
                tvLayoutParams.setMargins((int) PxUtils.pxFromDp(context, getResources().getDimension(R.dimen.field_view_small_margin_left_right)), 0, (int) PxUtils.pxFromDp(context, getResources().getDimension(R.dimen.field_view_small_margin_left_right)), 0);
                ...
                tvName.setTextSize(TypedValue.COMPLEX_UNIT_PX,
                        getResources().getDimension(R.dimen.textsize_field_small_name));
