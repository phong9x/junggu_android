 ...
 */
public class FieldViewText extends LinearLayout {

    private LinearLayout layoutName1, layoutName2, layoutName3, layoutName4, layoutName5;

    public FieldViewText(Context context) {
        super(context);
        init();
    }

    public FieldViewText(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public FieldViewText(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

//    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
//    public FieldViewText(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//    }
    ...
    private void init() {
        ...
        layoutInflater.inflate(R.layout.field_view_text_layout, this, true);
